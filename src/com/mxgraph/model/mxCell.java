...
public class mxCell implements mxICell, Cloneable, Serializable
{
	...
	/**
	 * Holds the cell type. Default is null.
	 */
	...
	protected boolean vertex = false, edge = false, connectable = true,
			visible = true, collapsed = false, isPort = false;
	...
	public mxCell(Object value, mxGeometry geometry, String style, String type)
	{
		setValue(value);
		setGeometry(geometry);
		setStyle(style);
	...
	public mxCell(Object value, mxGeometry geometry, String style, String type, boolean isPort)
	{
		setValue(value);
		setGeometry(geometry);
		setStyle(style);
	...
	/* (non-Javadoc)
	 * @see com.mxgraph.model.mxICell#getType()
	 */
	...
	/* (non-Javadoc)
	 * @see com.mxgraph.model.mxICell#setType(String)
	 */
