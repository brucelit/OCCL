...
public class mxGraph extends mxEventSource
{
	 ...
	 */
	public Object prepareContext(Object parent, String id, Object value, double x,
							   double y, double width, double height, String style, String type)
	{
...
//				if (myCell.getType().equals("objContainer") | myCell.getType().equals("actContainer"))
//					return false;
//			}
//		}
