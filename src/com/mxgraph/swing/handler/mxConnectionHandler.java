...
//			return;
//		}
//		// avoid self connected line
//		if (c1.getParent().getId().equals(mw.getSrcPortParentId())) {
//			return;
//		}
						...
						.isAllowDanglingEdges()))
				{
					...
					try
					{
						...
						if (cell != null)
						{
							...
							else if ((targetPortType.equals("beforePort") && refPortType.equals("afterPort"))
							|| (targetPortType.equals("afterPort") && refPortType.equals("beforePort"))){
						...
						e.consume();
						if (refPortType.equals("objRef") && targetPortType.equals("objRef")) {
							// set up a dialog for the connection
							setDialogForObjToObjCardinality(c1, refParentValue, targetParentValue);
						}
						else if ((refPortType.equals("actRef") && targetPortType.equals("objRef"))
								|| refPortType.equals("objRef") && targetPortType.equals("actRef")) {
							// set up a dialog for the connection
							setDialogForActToObjCardinality(c1, refParentValue, targetParentValue);
						}
						if (refPortType.equals("stateBefore") && targetPortType.equals("state")) {
							// set up a dialog for the connection
							setDialogForObjToObjCardinality(c1, refParentValue, targetParentValue);
						}
						else if ((refPortType.equals("actRef") && targetPortType.equals("objRef"))
						...
						else if ((refPortType.equals("activityBefore") && targetPortType.equals("activityAfter"))
								|| refPortType.equals("activityAfter") && targetPortType.equals("activityBefore")) {
							// set up a dialog for the connection
							setDialogForActToActOrder(c1, refParentValue, targetParentValue);
						}
						else{
							return;
						}
	 ...
	 */
	public void setDialogForActToActOrder(mxCell cell, String refObj, String targetObj){
		...
		jcb.addItem("non-response");
//		jcb.addItem("non-precedence");
//		jcb.addItem("unary-precedence");
//		jcb.addItem("co-existence");
//		jcb.addItem("non-co-existence");
		jcb.setSize(new Dimension(150,20));
		...
		jl1.setSize(new Dimension(235,20));
		jl1.setMinimumSize(new Dimension(235,20));
		jl1.setMaximumSize(new Dimension(235,20));
		jl1.setPreferredSize(new Dimension(235,20));
		infoBox.add(jl1);
		infoBox.add(jb2);
		...
		hBox4.setAlignmentX(Component.CENTER_ALIGNMENT);
		hBox4.add(jbConfirm);
	...
	/**
	 * obj to obj cardinality
	 */
	public void setDialogForObjToObjCardinality(mxCell cell, String refObj, String targetObj){
		// add the id of the edge to the middleware

		// use a dialog to set the type of the edge
		JDialog dialog = new JDialog();
		dialog.setTitle("Cardinality Setting");
		...
		// jta1 to fill in cardinality
		JTextArea jta1 = new JTextArea();
		jta1.setSize(new Dimension(20,20));
		jta1.setMaximumSize(new Dimension(20,20));
		jta1.setPreferredSize(new Dimension(20,20));


		JTextArea jta2 = new JTextArea();
		jta2.setSize(new Dimension(20,20));
		jta2.setMaximumSize(new Dimension(20,20));
		jta2.setPreferredSize(new Dimension(20,20));
	 ...
	 * obj to obj cardinality
	 */
	public void setDialogForActToObjCardinality(mxCell cell, String refActivity, String targetObj){
		// add the id of the edge to the middleware
		...
		JButton jb1 = new JButton(refActivity);
		jb1.setEnabled(false);
		JButton jb2 = new JButton(targetObj);
		jb2.setEnabled(false);
		Box hBox1 = Box.createHorizontalBox();
